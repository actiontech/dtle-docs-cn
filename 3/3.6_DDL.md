...
<table>
    ...
    <tr>
        ...
        <td>应支持</td>
        <td>支持</td>
        <td>1.  https://github.com/actiontech/dtle/issues/786<br>
        2. 支持server级默认字符集不一致情形</td>
    </tr>
    <tr>
        ...
        <td>支持</td>
        <td>1.  https://github.com/actiontech/dtle/issues/786<br>
        2. 支持字符集latin1、latin2、gbk、utf8、utf8mb4、binary</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>应支持</td>
        <td>支持</td>
        <td>https://github.com/actiontech/dtle/issues/802</td>
    </tr>
    <tr>
        <td>range</td>
    ...
    <tr>
        ...
        <td>应支持</td>
        <td>支持</td>
        <td>https://github.com/actiontech/dtle/issues/803</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>支持</td>
        <td>支持</td>
        <td>新表不会在目标端创建，DTLE会有ERROR log<br>
    ...
    <tr>
        ...
        <td>/</td>
        <td>支持</td>
        <td>https://github.com/actiontech/dtle/issues/790 (fixed)<br><br>
        重命名成功，后续数不应据传到目标端<br><br>
        {<br>
          "replicate_do_db": [<br>
            {<br>
              "table_schema": "action_db_1",<br>
...
<table>
    ...
    <tr>
        ...
        <td>不支持</td>
        <td>支持</td>
        <td rowspan="3">1.目标端账户需要CREATE VIEW, SUPER权限<br>
        2.全量不复制view</td>
    </tr>
    <tr>
        <td>ALTER VIEW</td>
